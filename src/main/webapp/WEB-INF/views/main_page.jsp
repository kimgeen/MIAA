...
<div>
	<main>
		...
		<div style="width: 100%; height: 65%;  display: flex; justify-content: center; align-items: center; margin: auto; margin-top: 20px; text-align: center; margin-top: 60px; margin-bottom: 80px;">
			<div
          ...
          <div class="carousel_wrapper">
            <div class="carousel_slide">
              <img src="resources/img/lostimg.png" alt="#" />
            </div>
            <div class="carousel_slide">
              <img src="resources/img/lostimg.png" alt="#" />
            </div>
