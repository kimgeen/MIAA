...
<script src="<c:url value="/resources/js/jquery-3.7.1.min.js"/>"
...
<body>
	<div class="main-container">
		<div class="main-selection">
			...
			<div class="main-selection-flex">
				<div class="main-selection-ex">
					<div class="title">실종동물 등록</div>
					<div class="describe">실종된 동물을 등록하시면 내정보 알림게시판에서 보호동물에 대한 정보를
						받아보실 수 있습니다.</div>
				</div>
			</div>
		</div>
		...
		<!-- form 시작 -->
		<form action="missing_ani_write" method="post"
				...
				<div class="table-container">
					...
					<div class="table">
						<div class="table-row">
							...
							<div class="row-content">
								<input type="date" name="Missingday" id="Missingday">
							</div>
						</div>
						<div class="table-row">
							<div class="row-title">
	...
	<script>
		$(document).ready(
				function() {//로드완료시
					...
					document.getElementById("Missingday").setAttribute("value",
